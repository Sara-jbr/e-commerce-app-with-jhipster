  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="eCommerceAppJhipsterApp.productCategory.home.createOrEditLabel" data-cy="ProductCategoryCreateUpdateHeading">
            <Translate contentKey="eCommerceAppJhipsterApp.productCategory.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('eCommerceAppJhipsterApp.productCategory.name')}
              ...
              />
              <ValidatedField
                label={translate('eCommerceAppJhipsterApp.productCategory.description')}
