...
export const ProductCategoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="eCommerceAppJhipsterApp.productCategory.delete.question">
        <Translate contentKey="eCommerceAppJhipsterApp.productCategory.delete.question" interpolate={{ id: productCategoryEntity.id }}>
