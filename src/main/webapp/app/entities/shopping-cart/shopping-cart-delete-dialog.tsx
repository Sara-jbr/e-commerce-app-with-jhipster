...
export const ShoppingCartDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="eCommerceAppJhipsterApp.shoppingCart.delete.question">
        <Translate contentKey="eCommerceAppJhipsterApp.shoppingCart.delete.question" interpolate={{ id: shoppingCartEntity.id }}>
