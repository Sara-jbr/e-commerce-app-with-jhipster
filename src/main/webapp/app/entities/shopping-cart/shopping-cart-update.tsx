  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="eCommerceAppJhipsterApp.shoppingCart.home.createOrEditLabel" data-cy="ShoppingCartCreateUpdateHeading">
            <Translate contentKey="eCommerceAppJhipsterApp.shoppingCart.home.createOrEditLabel">Create or edit a ShoppingCart</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('eCommerceAppJhipsterApp.shoppingCart.placedDate')}
              ...
              />
              <ValidatedField
                label={translate('eCommerceAppJhipsterApp.shoppingCart.status')}
              ...
              >
                {orderStatusValues.map(orderStatus => (
                  <option value={orderStatus} key={orderStatus}>
                    {translate('eCommerceAppJhipsterApp.OrderStatus.' + orderStatus)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('eCommerceAppJhipsterApp.shoppingCart.totalPrice')}
              ...
              />
              <ValidatedField
                label={translate('eCommerceAppJhipsterApp.shoppingCart.paymentMethod')}
              ...
              >
                {paymentMethodValues.map(paymentMethod => (
                  <option value={paymentMethod} key={paymentMethod}>
                    {translate('eCommerceAppJhipsterApp.PaymentMethod.' + paymentMethod)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('eCommerceAppJhipsterApp.shoppingCart.paymentReference')}
              ...
              <ValidatedField
                ...
                label={translate('eCommerceAppJhipsterApp.shoppingCart.customerDetails')}
                type="select"
                required
              >
                <option value="" key="0" />
