  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="eCommerceAppJhipsterApp.productOrder.home.createOrEditLabel" data-cy="ProductOrderCreateUpdateHeading">
            <Translate contentKey="eCommerceAppJhipsterApp.productOrder.home.createOrEditLabel">Create or edit a ProductOrder</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('eCommerceAppJhipsterApp.productOrder.quantity')}
              ...
              />
              <ValidatedField
                label={translate('eCommerceAppJhipsterApp.productOrder.totalPrice')}
              ...
              <ValidatedField
                ...
                name="product"
                data-cy="product"
                label={translate('eCommerceAppJhipsterApp.productOrder.product')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="cart"
                data-cy="cart"
                label={translate('eCommerceAppJhipsterApp.productOrder.cart')}
                type="select"
                required
              >
                <option value="" key="0" />
