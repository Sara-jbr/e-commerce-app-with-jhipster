...
export const ProductOrderDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="eCommerceAppJhipsterApp.productOrder.delete.question">
        <Translate contentKey="eCommerceAppJhipsterApp.productOrder.delete.question" interpolate={{ id: productOrderEntity.id }}>
