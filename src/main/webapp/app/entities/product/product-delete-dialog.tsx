...
export const ProductDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="eCommerceAppJhipsterApp.product.delete.question">
        <Translate contentKey="eCommerceAppJhipsterApp.product.delete.question" interpolate={{ id: productEntity.id }}>
