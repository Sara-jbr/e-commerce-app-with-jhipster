  ...
  return (
    <div>
      <h2 id="customer-details-heading" data-cy="CustomerDetailsHeading">
        <Translate contentKey="eCommerceAppJhipsterApp.customerDetails.home.title">Customer Details</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="eCommerceAppJhipsterApp.customerDetails.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/customer-details/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="eCommerceAppJhipsterApp.customerDetails.home.createLabel">Create new Customer Details</Translate>
          </Link>
        </div>
      </h2>
        ...
        {customerDetailsList && customerDetailsList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="eCommerceAppJhipsterApp.customerDetails.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('gender')}>
                  <Translate contentKey="eCommerceAppJhipsterApp.customerDetails.gender">Gender</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('gender')} />
                </th>
                <th className="hand" onClick={sort('phone')}>
                  <Translate contentKey="eCommerceAppJhipsterApp.customerDetails.phone">Phone</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('phone')} />
                </th>
                <th className="hand" onClick={sort('addressLine1')}>
                  <Translate contentKey="eCommerceAppJhipsterApp.customerDetails.addressLine1">Address Line 1</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('addressLine1')} />
                </th>
                <th className="hand" onClick={sort('addressLine2')}>
                  <Translate contentKey="eCommerceAppJhipsterApp.customerDetails.addressLine2">Address Line 2</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('addressLine2')} />
                </th>
                <th className="hand" onClick={sort('city')}>
                  <Translate contentKey="eCommerceAppJhipsterApp.customerDetails.city">City</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('city')} />
                </th>
                <th className="hand" onClick={sort('country')}>
                  <Translate contentKey="eCommerceAppJhipsterApp.customerDetails.country">Country</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('country')} />
                </th>
                <th>
                  <Translate contentKey="eCommerceAppJhipsterApp.customerDetails.user">User</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {customerDetailsList.map((customerDetails, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`eCommerceAppJhipsterApp.Gender.${customerDetails.gender}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="eCommerceAppJhipsterApp.customerDetails.home.notFound">No Customer Details found</Translate>
            </div>
          )
        )}
      </div>
