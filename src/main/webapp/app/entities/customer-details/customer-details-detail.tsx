    ...
    <Row>
      <Col md="8">
        <h2 data-cy="customerDetailsDetailsHeading">
          <Translate contentKey="eCommerceAppJhipsterApp.customerDetails.detail.title">CustomerDetails</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="eCommerceAppJhipsterApp.customerDetails.user">User</Translate>
          </dt>
