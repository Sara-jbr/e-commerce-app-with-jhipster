  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="eCommerceAppJhipsterApp.customerDetails.home.createOrEditLabel" data-cy="CustomerDetailsCreateUpdateHeading">
            <Translate contentKey="eCommerceAppJhipsterApp.customerDetails.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('eCommerceAppJhipsterApp.customerDetails.gender')}
              ...
              >
                {genderValues.map(gender => (
                  <option value={gender} key={gender}>
                    {translate('eCommerceAppJhipsterApp.Gender.' + gender)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('eCommerceAppJhipsterApp.customerDetails.phone')}
              ...
              />
              <ValidatedField
                label={translate('eCommerceAppJhipsterApp.customerDetails.addressLine1')}
              ...
              />
              <ValidatedField
                label={translate('eCommerceAppJhipsterApp.customerDetails.addressLine2')}
              ...
              />
              <ValidatedField
                label={translate('eCommerceAppJhipsterApp.customerDetails.city')}
              ...
              />
              <ValidatedField
                label={translate('eCommerceAppJhipsterApp.customerDetails.country')}
              ...
              <ValidatedField
                ...
                name="user"
                data-cy="user"
                label={translate('eCommerceAppJhipsterApp.customerDetails.user')}
                type="select"
                required
              >
                <option value="" key="0" />
