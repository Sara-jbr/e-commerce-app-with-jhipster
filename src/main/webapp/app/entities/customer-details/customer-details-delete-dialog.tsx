...
export const CustomerDetailsDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="eCommerceAppJhipsterApp.customerDetails.delete.question">
        <Translate contentKey="eCommerceAppJhipsterApp.customerDetails.delete.question" interpolate={{ id: customerDetailsEntity.id }}>
